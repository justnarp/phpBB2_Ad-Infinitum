	...
	<tr> 
		...
		<td class="row2 four">
			...
			<div>
				...
				<option style="color:#ebebeb; background-color: {T_TD_COLOR1}" value="white">{L_COLOR_DEFAULT}</option>
			...
			<div>
				<input type="text" name="helpbox" maxlength="100" class="helpline postbiggest" value="{L_STYLES_TIP}" style="color: #e5e5e5" />
			</div>
