		...
		<table cellspacing="1" style="margin: 0 auto">
			...
			<tr>
				...
				<td align="center"><table cellspacing="0" style="width: 8px;">
					<tr>
						<td style="padding: 0; vertical-align: bottom;"><img src="templates/AdInfinitum/images/vote_lcap.gif" style="width: 4px; height: 12px;" alt="" /></td>
						...
						<td style="padding: 0; vertical-align: bottom;"><img src="templates/AdInfinitum/images/vote_rcap.gif" style="width: 4px; height: 12px;" alt="" /></td>
					</tr>
